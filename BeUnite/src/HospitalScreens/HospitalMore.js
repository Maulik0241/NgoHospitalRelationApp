...
export default function HospitalMore() {
  ...
  return (
    ...
    <View style={styles.container}>
      <TouchableOpacity onPress={() => handleNavigate('HospitalProfile')} style={styles.link}>
      <MaterialCommunityIcons name="account" color='#FFFF' size={40} style={styles.icons} />
        <Text style={styles.linkText}>Profile</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => handleNavigate('HospitalActivity')} style={styles.link}>
      <MaterialCommunityIcons name="note-plus" color='#FFFF' size={40} style={styles.icons} />
        <Text style={styles.linkText}>Activity</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => handleNavigate('HospitalContactUs')} style={styles.link}>
      <MaterialCommunityIcons name="phone-outgoing-outline" color='#FFFF' size={40} style={styles.icons} />
        <Text style={styles.linkText}>Contact Us</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => handleNavigate('HospitalPolicy')} style={styles.link}>
