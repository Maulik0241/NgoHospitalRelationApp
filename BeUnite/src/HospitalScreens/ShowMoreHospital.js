...
export default function ShowMoreHospital({route}) {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.orgName}>{ngoData.orgname}</Text>
      <View style={styles.infoContainer}>
        <Text style={styles.label}>Contact Name: </Text>
        <Text style={styles.value}>{ngoData.contactname}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.label}>Address: </Text>
        <Text style={styles.value}>{ngoData.address}</Text>
      </View>
      <View style={styles.infoContainer}>
